...
public class Person {
    ...
    public String setPersonId(int personId) {
        ...
        if (personId >= 101 && personId <= 999)
            ...
            errMsg = (personId) + " is invalid. PersonId must be >= 101 and <= 999.";
    ...
    public String setLastName(String lastName) {
        ...
        if (lastName.length() > 2 && lastName.length() <= 30)
            ...
            errMsg = lastName + " is invalid. User name must be > 2 and <= 30 characters.";
    ...
    public String setUserName(String userName) {
        ...
        if (userName.length() >= 5 && userName.length() <= 30) {
            ...
            errMsg = userName + " is invalid. Last name must be > 2 and <= 30 characters.";
